        ...
        <div className="min-h-screen text-white p-6 md:p-12 mt-20">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    {/* Main Result Display */}
                    <div className="lg:col-span-2 space-y-6l">
                        <div className="glass-panel inline-block p-2 rounded-2xl">
                            <div className={`${project?.aspectRatio === '9:16' ? 'aspect-9/16' : 'aspect-video'} sm:max-h-200 rounded-xl bg-gray-500 overflow-hidden`}>
                                {project?.generatedVideo ? (
                                    <video src={project.generatedVideo} controls autoPlay loop className="w-full object-cover" />
                                ) : (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="glass-panel p-6 rounded-2xl relative overflow-hidden">
                            ...
                            <p className="text-gray-400 text-sm mb-6">Turn this static image into a dynamic vedio for social media</p>
