                ...
                <div className={`${gen?.aspectRatio === '9:16' ? 'aspect-9/16' : 'aspect-video'} relative overflow-hidden`}>
                    ...
                    {!forCommunity && (
                        ...
                        <div className="flex flex-col items-end w-32 text-sm">
                            <ul className={`text-xs ${menuOpen ? 'block' : 'hidden'} overflow-hidden right-0 top-0 absolute peer-focus:block hover:block w-40 bg-black/50 backdrop-blur text-white border-gray-500/50 rounded-lg shadow-md mt-2 py-1 z-10`}> 
                ...
                <div className="p-3">
                    ...
                    {!forCommunity && (
                        <div className='mt-4 grid grid-cols-2 gap-3'>
                            ...
                            <PrimaryButton onClick={()=> togglePublicsh(gen.id)} className='rounded-md'>
